...
MyQRectF::MyQRectF(const MyQRectF & other) :
    ...
    ancestryHaveGravityCenterBeyondContour(other.ancestryHaveGravityCenterBeyondContour)
{
}
...
MyQRectF::MyQRectF(const QPointF & topLeft,
    ...
    ancestryHaveGravityCenterBeyondContour(ancestryHaveGravityCenterBeyondContour)
{
}

MyQRectF::MyQRectF(const qreal x,
        const qreal y,
        const qreal width,
        const qreal height,
        const QString & name,
